...
import { frame, sceneSplat, splatLayers, splatStatus } from '../state'
...
<template>
  <aside class="inspector">
    ...
    <section>
      ...
      <div class="row">
        <span class="muted">In the cache</span>
        <span class="num" v-if="sceneSplat">{{ sceneSplat.n_ready }} of {{ sceneSplat.n_total }} keyframes</span>
        <span class="muted" v-else>…</span>
      </div>
      <p class="note muted">Every combination of views and cameras is computed offline by the compute CLI and read from data/cache/splat. The viewer never runs the model.</p>
    </section>
